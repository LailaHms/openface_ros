...
float64 intensity"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose','geometry_msgs/Pose','geometry_msgs/Vector3','geometry_msgs/Pose','geometry_msgs/Point[]','geometry_msgs/Point[]','openface_ros/ActionUnit[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_units = []
      for i in range(0, length):
        val1 = openface_ros.msg.ActionUnit()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
